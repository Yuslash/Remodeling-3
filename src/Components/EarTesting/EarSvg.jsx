...
export default function EarSvg() {
  return (
    ...
    >
      <g className="ear-container" id="completed">
        <g id="Frame 97">
          <rect width="42.7" height="42.7" transform="translate(7 14)" fill="#050505" />
        </g>
        <g
          id="earleft"
          className="ear" /* Add CSS class for hover effect */
        >
          <path
            id="ear"
            d="M11 13.5H28.5L18.5 14L7.5 26V34.5L1 20.5V1L11 13.5Z"
            fill="url(#paint0_linear_203_4814)"
            stroke="#2A2647"
            strokeWidth="0.1"
          />
          <g id="inner ear">
          ...
          <path
            id="outerar"
            d="M14.5 12L1 1L11 13.5H20.5L14.5 12Z"
            fill="url(#paint2_linear_203_4814)"
            stroke="#2C2947"
            strokeWidth="0.1"
          />
        </g>
        ...
        >
          <path
            id="ear_2"
            d="M45.5 13.5H28L38 14L49 26V34.5L55.5 20.5V1L45.5 13.5Z"
            fill="url(#paint3_linear_203_4814)"
            stroke="#2A2647"
            strokeWidth="0.1"
          />
          <g id="inner ear_2">
          ...
          <path
            id="outerar_2"
            d="M42 12L55.5 1L45.5 13.5H36L42 12Z"
            fill="url(#paint5_linear_203_4814)"
            stroke="#2C2947"
            strokeWidth="0.1"
          />
        </g>
